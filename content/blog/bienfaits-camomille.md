...
excerpt: "La camomille est la tisane la plus bue de France et l'une des plus mal préparées. Voici ce qu'on peut honnêtement en dire, et où je m'arrête."
image: "/images/blog/bienfaits-camomille.webp"
imageAlt: "Camomille sauvage en fleurs et coquelicots en bordure d'un champ"
imageCredit: "Photo par JackyM59 via Wikimedia Commons (CC BY-SA 4.0)"
author: helene-vasseur
categories: ["Bienfaits et santé"]
tags: ["camomille", "tisane", "bienfaits", "sommeil", "matricaire"]
icon: "heart"
faq:
  - q: "Quelle différence entre camomille matricaire et camomille romaine ?"
    a: "Ce sont deux plantes distinctes. La camomille matricaire, ou camomille allemande (Matricaria chamomilla), est celle qu'on trouve dans la quasi-totalité des tisanes du commerce : son goût rappelle la pomme. La camomille romaine (Chamaemelum nobile) est nettement plus amère et son usage traditionnel est différent. Quand un paquet indique simplement camomille, il s'agit presque toujours de la matricaire."
  - q: "La camomille aide-t-elle à dormir ?"
    a: "C'est son usage traditionnel le plus ancien et le plus répandu, et les données scientifiques disponibles sur ce point précis restent limitées et portent sur de petits effectifs. Ce qui est solidement établi, c'est qu'une boisson chaude sans caféine prise avant le coucher fait partie des rituels qui favorisent l'endormissement. La part de la plante et la part du rituel sont difficiles à démêler."
  - q: "La camomille contient-elle de la caféine ?"
    a: "Non, aucune. La camomille est une infusion de fleurs, pas un thé, et ne contient donc ni théine ni caféine. C'est d'ailleurs la raison la plus solide de la boire le soir, indépendamment de tout autre effet qu'on lui prête."
  - q: "Y a-t-il des précautions à prendre avec la camomille ?"
    a: "La camomille appartient à la famille des astéracées, comme l'ambroisie, l'armoise et le chrysanthème. Les personnes allergiques à ces plantes peuvent réagir à la camomille. En cas de grossesse, de traitement médicamenteux ou d'usage prolongé et intensif, la question se pose avec un médecin ou un pharmacien, pas sur un blog."
  - q: "Combien de temps infuser la camomille ?"
    a: "Cinq à dix minutes dans une eau à 100 °C, tasse couverte. Le couvercle est important : les composés aromatiques des fleurs sont volatils et une bonne partie du parfum part avec la vapeur si la tasse reste ouverte. Comptez une cuillère à soupe de fleurs entières par tasse, les capitules étant très légers."
---
...
Quand un article vous parle des vertus de « la camomille » sans préciser laquelle, il y a de bonnes chances qu'il recopie sans comprendre. C'est exactement la même confusion que celle que j'ai décrite à propos de [la verveine](/blog/bienfaits-verveine/).
...
C'est le même principe que pour la plupart des plantes aromatiques, détaillé dans nos [tisanes de grand-mère pour l'hiver](/blog/tisanes-grand-mere-hiver/) et dans le [guide d'infusion](/guide-infusion/).
...
Pour d'autres plantes que je bois le soir, voyez la [tisane de feuille de framboisier](/blog/tisane-feuille-framboisier/). Le [glossaire](/glossaire/) rappelle au passage pourquoi une tisane n'est pas un thé, distinction qui vaut pleinement ici.
