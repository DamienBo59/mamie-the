...
excerpt: "Un kit matcha contient quatre à six objets et un seul est vraiment irremplaçable. Voici lequel, et comment choisir la poudre qui va avec."
image: "/images/blog/kit-matcha.webp"
imageAlt: "Bol de matcha fouetté, mousse verte à la surface, sur un fond rouge"
imageCredit: "Photo par rumpleteaser via Wikimedia Commons (CC BY 2.0)"
author: helene-vasseur
categories: ["Variétés de thé"]
tags: ["kit matcha", "chasen", "matcha", "matériel", "grade cérémonial"]
icon: "sparkle"
faq:
  ...
  - q: "Comment entretenir un fouet à matcha ?"
    a: "Rincer à l'eau chaude claire immédiatement après usage, jamais de savon, jamais de lave-vaisselle, et ne jamais le laisser tremper. Il sèche ensuite à l'air, posé sur son repose-fouet qui maintient l'écartement des brins. Quelques brins finissent par casser avec le temps, c'est normal : un chasen utilisé régulièrement dure de quelques mois à un an."
  - q: "Quelles proportions pour un matcha ?"
    a: "Comptez 2 g de poudre tamisée, soit environ deux cuillerées de chashaku ou une demi-cuillère à café, pour 70 ml d'eau à 70 à 80 °C. Fouettez vingt secondes en dessinant des W rapides, poignet souple, sans tourner en rond. Le tamisage n'est pas facultatif : le matcha s'agglomère en séchant et les grumeaux ne se défont pas au fouet."
---
...
Sur la question plus large du contenant et de ce qu'il change au goût, j'ai détaillé les matières et les contenances dans l'article sur les [tasses à thé](/blog/tasses-a-the/).
...
Pour la version au lait, qui tolère très bien un grade culinaire, la méthode est dans notre article [matcha latte](/blog/matcha-latte/). Et sur ce que contient réellement cette poudre, j'ai fait le tri dans les [bienfaits du matcha](/blog/the-matcha-bienfaits/).

## Ce que j'achèterais

Un **chasen à 80 brins**, un **petit tamis**, et une boîte de **matcha cérémonial de 30 g**. Le bol, prenez-le dans votre placard.

Si vous vous y mettez sérieusement, le repose-fouet devient vite un bon achat : c'est lui qui prolonge la vie du chasen, qui est la pièce la plus fragile et celle qu'on rachète. Le [guide d'infusion](/guide-infusion/) reprend les températures pour les autres thés verts japonais, qui ne se préparent pas du tout de la même façon.
